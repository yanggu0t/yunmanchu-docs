        ...
        return (
          <Card
            ...
            className={cn(
              ...
              feature.highlight && 'ring-primary/20 bg-primary/5 ring-2'
            )}
          >
...
export const COMMON_ROOM_FEATURES: RoomFeature[] = [
  {
    ...
    title: '乾濕分離浴室',
    description:
      '浴室配有冷暖風乾燥機，廁所及衛浴之間設有乾濕分離設計，使用更舒適衛生。',
  },
  {
    icon: Refrigerator,
    title: '小冰箱',
    description:
      '房間內配有小冰箱，可以放心帶著需要冷藏的東西來入住，保持食物新鮮。',
  },
  {
    icon: Bed,
    title: '舒適寢具',
    description:
      '我們採用的床和棉被軟硬適中，多數來過的客人都給予好評，歡迎入住體驗。',
  },
  {
    icon: Sparkles,
    title: '有機盥洗用品',
